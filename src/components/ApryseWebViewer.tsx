        ...
        <div className="flex items-center bg-white border-b border-gray-100 px-2 min-h-[38px] gap-1">
          <div className="flex items-center gap-0.5 flex-1 overflow-x-auto">
            {openTabs.map((tab) => (
              <div
                key={tab.id}
                className={`flex items-center px-3 py-1.5 rounded-lg text-[12px] cursor-pointer group min-w-0 max-w-[180px] transition-all ${tab.active
                  ? 'bg-blue-50 text-blue-700 font-semibold'
                  : 'text-gray-500 hover:bg-gray-100 hover:text-gray-700 font-medium'
                  }`}
                onClick={() => switchTab(tab.id)}
              >
                <FileText className={`w-3.5 h-3.5 mr-1.5 flex-shrink-0 ${tab.active ? 'text-blue-500' : 'text-gray-400'}`} />
                ...
                {openTabs.length > 1 && (
                  <button
                    ...
                    className="ml-1.5 opacity-0 group-hover:opacity-100 hover:bg-gray-200 rounded p-0.5 flex-shrink-0 transition-opacity"
                    title="Close tab"
                  >
            ...
            <button
              ...
              className="px-2.5 py-1.5 text-[12px] text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg flex items-center gap-1 transition-colors font-medium"
          ...
          <div className="flex items-center gap-1 ml-2 shrink-0">
            <button
              ...
              className={`px-2.5 py-1.5 text-[12px] rounded-lg flex items-center gap-1 transition-all font-medium ${showWikiPanel ? 'bg-indigo-50 text-indigo-600' : 'text-gray-400 hover:text-indigo-600 hover:bg-gray-100'}`}
            ...
            <button
              ...
              className={`px-2.5 py-1.5 text-[12px] rounded-lg flex items-center gap-1 transition-all font-medium ${showSectionAssignment ? 'bg-blue-50 text-blue-600' : 'text-gray-400 hover:text-blue-600 hover:bg-gray-100'}`}
